import{R as e,P as i,r as h,A as q,j as x,k as L}from"./vendor-DasOq3Un.js";import{u as U,c as F,f as H}from"./index-3mKLI-Jn.js";/* empty css             */function E({currentPage:t,totalPages:r,onPageChange:a}){const s=()=>{const o=[],l=Math.max(1,t-1),d=Math.min(r,l+3);for(let g=l;g<=d;g++)o.push(g);return o},n=o=>{a(o);const l=document.getElementById("posts");l&&l.scrollIntoView({behavior:"smooth",block:"start"})};return e.createElement("div",{className:"pagination"},e.createElement("button",{onClick:()=>n(t-1),disabled:t===1},"Previous"),s().map(o=>e.createElement("button",{key:o,className:o===t?"active":"",onClick:()=>n(o)},o)),e.createElement("button",{onClick:()=>n(t+1),disabled:t===r},"Next"))}E.propTypes={currentPage:i.number.isRequired,totalPages:i.number.isRequired,onPageChange:i.func.isRequired};const S=({pdfImages:t})=>{const[r,a]=h.useState(1),[s,n]=h.useState(!1),[o,l]=h.useState(1),d=h.useRef(null),g=()=>{const u=new Image;u.src=t[o-1],u.onload=()=>{const m=d.current,f=m.getContext("2d"),v=window.devicePixelRatio||1,D=s?window.innerWidth:m.parentElement.clientWidth,O=Math.min(D/u.width,1),A=r*O,y=u.width*A,b=u.height*A;m.width=y*v,m.height=b*v,m.style.width=`${y}px`,m.style.height=`${b}px`,f.clearRect(0,0,m.width,m.height),f.scale(v,v),f.drawImage(u,0,0,y,b)},u.onerror=()=>{console.error("Failed to load image:",u.src);const m=d.current,f=m.getContext("2d");f.clearRect(0,0,m.width,m.height),f.font="20px Arial",f.fillStyle="red",f.fillText("Failed to load page",10,50)}};h.useEffect(()=>{g()},[r,s,o]);const c=()=>a(u=>Math.min(u+.1,2)),p=()=>a(u=>Math.max(u-.1,.5)),R=()=>n(!0),M=()=>n(!1),I=()=>{o<t.length&&l(o+1)},N=()=>{o>1&&l(o-1)};return e.createElement("div",{className:`pdf-viewer-container ${s?"full-view":"min-view"}`},s&&e.createElement("div",{className:"pdf-navbar"},e.createElement("button",{className:"minimize-view-btn",onClick:M},e.createElement(q,null)),e.createElement("div",{className:"zoom"},e.createElement("button",{onClick:c},e.createElement(x,null)),e.createElement("button",{onClick:p,disabled:r<=.5},e.createElement(L,null))),e.createElement("div",{className:"pdf-pagination"},e.createElement("button",{onClick:N,disabled:o<=1},"Prev"),e.createElement("span",null,"Page ",o," of ",t.length),e.createElement("button",{onClick:I,disabled:o>=t.length},"Next"))),e.createElement("canvas",{onClick:R,ref:d,className:"pdf-viewer-canvas"}))};S.propTypes={pdfImages:i.array.isRequired};function T({pdfImages:t,isLoaded:r}){return e.createElement("section",{className:"pdf-post"},r?e.createElement("div",{className:"pdf-container"},e.createElement(S,{pdfImages:t})):e.createElement("div",{className:"placeholder pdf-container-placeholder"}))}T.propTypes={pdfImages:i.array.isRequired,isLoaded:i.bool.isRequired};function C({iframeUrls:t}){const[r,a]=h.useState(!1),[s,n]=h.useState(0),o=c=>{c.stopPropagation(),a(p=>!p)},l=()=>{n(c=>c<t.length-1?c+1:c)},d=()=>{n(c=>c>0?c-1:c)},g=Array.isArray(t)?t[s]:t;return e.createElement("div",{className:`google-doc-viewer ${r?"fullscreen":""}`},e.createElement("iframe",{src:g,allowFullScreen:!0,className:"google-doc-iframe"}),e.createElement("div",{className:"navigation-buttons"},Array.isArray(t)&&e.createElement(e.Fragment,null,e.createElement("button",{className:"prev-doc-button",onClick:d,disabled:s===0},"Previous"),e.createElement("button",{className:"next-doc-button",onClick:l,disabled:s===t.length-1},"Next"))),e.createElement("button",{className:"toggle-fullscreen",onClick:o},r?"Exit Full Screen":"Full Screen"))}C.propTypes={iframeUrls:i.oneOfType([i.string,i.arrayOf(i.string)]).isRequired};function B(t,r){return e.useMemo(()=>{if(t.length===0)return e.createElement(e.Fragment,null);const s=({innerHTML:n})=>e.createElement("div",{className:"summary",dangerouslySetInnerHTML:{__html:n}});return s.propTypes={innerHTML:i.string.isRequired},e.createElement("section",null,t.map((n,o)=>{var l,d;return e.createElement("article",{className:"job-post",key:o,onClick:()=>r(n)},n.imgSrc||n.iconLink?e.createElement("div",{className:"company-logo"},e.createElement("img",{loading:"lazy",src:n.imgSrc||n.iconLink,alt:"company logo"})):null,e.createElement("p",{className:"title"},(n==null?void 0:n.title)||(n==null?void 0:n.jobTitle)),((l=n==null?void 0:n.content)==null?void 0:l.length)>0?e.createElement(s,{innerHTML:n.content}):((d=n==null?void 0:n.details)==null?void 0:d.length)>0?e.createElement(s,{innerHTML:n.details}):n!=null&&n.iframe?e.createElement(C,{iframeUrls:n.iframe}):null,!(n!=null&&n.iframe)&&e.createElement("button",{className:"read-more-button",onClick:()=>r(n)},"Read More"))}))},[t,r])}function P({paginatedData:t,onPostClick:r}){const[a]=U(5e3);return e.createElement("div",{id:"posts"},t.map(s=>s.type==="pdf"?e.createElement(T,{key:s.id,pdfImages:s.pdfImages,isLoaded:a}):e.createElement(k,{key:s.id,post:s,onPostClick:r})))}P.propTypes={paginatedData:i.arrayOf(i.shape({id:i.string.isRequired,type:i.string.isRequired,pdfImages:i.array,imgSrc:i.string,iconLink:i.string,title:i.string,jobTitle:i.string,details:i.string,content:i.string,apply:i.string,href:i.string})).isRequired,onPostClick:i.func.isRequired};function k({post:t,onPostClick:r}){return B([t],r)}k.propTypes={post:i.shape({id:i.string.isRequired,type:i.string.isRequired,pdfImages:i.array,imgSrc:i.string,iconLink:i.string,title:i.string,jobTitle:i.string,details:i.string,content:i.string,apply:i.string,href:i.string}).isRequired,onPostClick:i.func.isRequired};const j=[{file:"30.pdf",images:["./assets/pdf_images/30/30_page_1.png","./assets/pdf_images/30/30_page_2.png"]},{file:"31.pdf",images:["./assets/pdf_images/31/31_page_1.png","./assets/pdf_images/31/31_page_2.png"]},{file:"32.pdf",images:["./assets/pdf_images/32/32_page_1.png"]},{file:"33.pdf",images:["./assets/pdf_images/33/33_page_1.png"]},{file:"34.pdf",images:["./assets/pdf_images/34/34_page_1.png"]},{file:"35.pdf",images:["./assets/pdf_images/35/35_page_1.png"]},{file:"36.pdf",images:["./assets/pdf_images/36/36_page_1.png","./assets/pdf_images/36/36_page_2.png"]},{file:"37.pdf",images:["./assets/pdf_images/37/37_page_1.png","./assets/pdf_images/37/37_page_2.png"]},{file:"38.pdf",images:["./assets/pdf_images/38/38_page_1.png","./assets/pdf_images/38/38_page_2.png"]},{file:"39.pdf",images:["./assets/pdf_images/39/39_page_1.png"]},{
["./assets/pdf_images/1/1_page_1.png","./assets/pdf_images/1/1_page_2.png"]},{file:"10.pdf",images:["./assets/pdf_images/10/10_page_1.png"]},{file:"11.pdf",images:["./assets/pdf_images/11/11_page_1.png"]},{file:"12.pdf",images:["./assets/pdf_images/12/12_page_1.png","./assets/pdf_images/12/12_page_2.png"]},{file:"13.pdf",images:["./assets/pdf_images/13/13_page_1.png","./assets/pdf_images/13/13_page_2.png"]},{file:"14.pdf",images:["./assets/pdf_images/14/14_page_1.png","./assets/pdf_images/14/14_page_2.png"]},{file:"15.pdf",images:["./assets/pdf_images/15/15_page_1.png","./assets/pdf_images/15/15_page_2.png"]},{file:"16.pdf",images:["./assets/pdf_images/16/16_page_1.png"]},{file:"17.pdf",images:["./assets/pdf_images/17/17_page_1.png","./assets/pdf_images/17/17_page_2.png"]},{file:"18.pdf",images:["./assets/pdf_images/18/18_page_1.png","./assets/pdf_images/18/18_page_2.png"]},{file:"19.pdf",images:["./assets/pdf_images/19/19_page_1.png","./assets/pdf_images/19/19_page_2.png","./assets/pdf_images/19/19_page_3.png","./assets/pdf_images/19/19_page_4.png"]},{file:"2.pdf",images:["./assets/pdf_images/2/2_page_1.png"]},{file:"20.pdf",images:["./assets/pdf_images/20/20_page_1.png"]},{file:"21.pdf",images:["./assets/pdf_images/21/21_page_1.png","./assets/pdf_images/21/21_page_2.png","./assets/pdf_images/21/21_page_3.png"]},{file:"22.pdf",images:["./assets/pdf_images/22/22_page_1.png","./assets/pdf_images/22/22_page_2.png"]},{file:"23.pdf",images:["./assets/pdf_images/23/23_page_1.png"]},{file:"24.pdf",images:["./assets/pdf_images/24/24_page_1.png","./assets/pdf_images/24/24_page_2.png"]},{file:"25.pdf",images:["./assets/pdf_images/25/25_page_1.png","./assets/pdf_images/25/25_page_2.png"]},{file:"26.pdf",images:["./assets/pdf_images/26/26_page_1.png","./assets/pdf_images/26/26_page_2.png"]},{file:"27.pdf",images:["./assets/pdf_images/27/27_page_1.png","./assets/pdf_images/27/27_page_2.png"]},{file:"28.pdf",images:["./assets/pdf_images/28/28_page_1.png"]},{file:"29.pdf",images:["./assets/pdf_images/29/29_page_1.png","./assets/pdf_images/29/29_page_2.png"]},{file:"3.pdf",images:["./assets/pdf_images/3/3_page_1.png","./assets/pdf_images/3/3_page_2.png"]},{file:"4.pdf",images:["./assets/pdf_images/4/4_page_1.png","./assets/pdf_images/4/4_page_2.png"]},{file:"5.pdf",images:["./assets/pdf_images/5/5_page_1.png","./assets/pdf_images/5/5_page_2.png"]},{file:"6.pdf",images:["./assets/pdf_images/6/6_page_1.png"]},{file:"7.pdf",images:["./assets/pdf_images/7/7_page_1.png","./assets/pdf_images/7/7_page_2.png"]},{file:"8.pdf",images:["./assets/pdf_images/8/8_page_1.png"]},{file:"9.pdf",images:["./assets/pdf_images/9/9_page_1.png","./assets/pdf_images/9/9_page_2.png"]}],G="/assets/agency_icons/minopex.png",_="minopex",z=[{jobTitle:"Engineering Artisan – Millwright (Shift)",publishedDate:"Published 13 August 2024",expiryDate:"Closing Date: 20 August 2024",location:"Remote",details:[`
        <h1>Job Details</h1>
    `,`
        <div class="col-md-6">
            <div class="col-md-6">
